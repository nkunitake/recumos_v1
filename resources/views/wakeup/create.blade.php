  ...
  <div class="py-12">
    <div class="flex flex-col text-center w-full mb-8">
        <h3 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">今日も早起き頑張りましたね！</h3>
          <p>{{ \Carbon\Carbon::now()->month }}月{{ \Carbon\Carbon::now()->day }}日{{ \Carbon\Carbon::now()->hour }}時{{ \Carbon\Carbon::now()->minute }}分に起きました。</p>
    </div>
          ...
          @csrf
            <div class="flex justify-center flex-col">
              <div class="flex flex-col justify-center text-center my-16">
                <div>
                  <h3 class="sm:text-lg text-lg font-medium title-font mb-4 text-gray-900">今日の気分はいかがでしたか？<br>（10点：スッキリ、1点：眠すぎ）</h3>
                </div>
